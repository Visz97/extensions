module.exports = { domain:"messages",
  locale_data:{ messages:{ "":{ domain:"messages",
      ...
      "A CSS syntax error was encountered":[ "Bir CSS söz dizimi hatasıyla karşılaşıldı" ],
      ...
      "Inline scripts blocked by default":[ "Satıriçi betikler varsayılan olarak engellenmiştir" ],
      "Known JS library detected":[ "Bilindik JS kütüphanesi algılandı" ],
      ...
      "Violation of Mozilla conditions of use.":[ "Mozilla kullanım koşullarının ihlali." ],
      "Package contains duplicate entries":[ "Paket yinelenen girdiler içermektedir" ],
      "Firefox add-ons are not allowed to run coin miners.":[ "Firefox eklentilerinin sanal para kazıcıları çalıştırmasına izin verilmemektedir." ],
      ...
      "A custom content_security_policy needs additional review.":[ "Özel bir content_security_policy ek inceleme gerektirir." ],
      "The \"name\" property must be a string.":[ "\"name\" özelliği bir string olmalıdır." ],
      "See http://mzl.la/1STmr48 (MDN Docs) for more information.":[ "Daha fazla bilgi için http://mzl.la/1STmr48 (MDN Docs) sayfasına bakın." ],
      "The \"version\" property must be a string.":[ "\"version\" özelliği string türünde olmalıdır." ],
      "See http://mzl.la/1kXIADa (MDN Docs) for more information.":[ "Daha fazla bilgi için http://mzl.la/1kXIADa (MDN Dökümanları) adresini ziyaret edin." ],
      "The \"version\" property uses a Firefox-specific format.":[ "\"version\" özelliği Firefox'a özgü bir biçim kullanıyor." ],
